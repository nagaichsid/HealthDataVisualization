...
public class PlaceLogDao {
  ...
  public List<PlaceLog> getPlaceLogByDate(String date) {
    String selectPlaceLogs="SELECT PlaceId, PlaceName, Longitude, Latitude, StartTime, EndTime, Date FROM PlaceLog WHERE Date=?;";
    ...
    try {
      ...
      while(resultSet.next()) {
        placeLogs.add(new PlaceLog(resultSet.getInt("PlaceId"),
